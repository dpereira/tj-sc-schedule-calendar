...
.modal-link { display: inline-flex; align-items: center; height: 36px; padding: 0 16px; background: #1a237e; color: #fff; text-decoration: none; border-radius: 4px; font-size: 0.9rem; box-sizing: border-box; }
.modal-link:hover { background: #283593; }
.modal-close { display: inline-flex; align-items: center; height: 36px; padding: 0 20px; background: #666; color: #fff; border: none; border-radius: 4px; cursor: pointer; font-size: 0.9rem; box-sizing: border-box; }
.modal-close:hover { background: #555; }
.modal-toggle { display: inline-flex; align-items: center; height: 36px; padding: 0 16px; background: #ff8f00; color: #fff; border: none; border-radius: 4px; cursor: pointer; font-size: 0.9rem; box-sizing: border-box; }
